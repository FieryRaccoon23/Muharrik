...
namespace MuharrikGame
{
    void GameScenes::InitScenes(Muharrik::Engine* engine)
    {
        ...
        entt::entity e1 = engine->OnCreateSpriteEntity(relativePath, 0.0f, 0.0f, 0.0f, 0.5f, 1.0f);
        ...
        entt::entity e2 = engine->OnCreateSpriteEntity(relativePath2, 250.0f, 0.0f, 0.0f, 0.5f, 1.0f);
